...
public class DropdownWidget<T> extends AbstractButton {
    ...
    /** Draws the open option list; the screen calls this in a later stratum, so it lands on top. */
    ...
    /** Draws a one-pixel border as four fills, GuiGraphicsExtractor having no outline helper. */
