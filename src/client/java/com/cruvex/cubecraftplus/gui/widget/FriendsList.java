...
public class FriendsList extends ObjectSelectionList<FriendsList.Entry> {
    ...
    public class Entry extends ObjectSelectionList.Entry<Entry> {
        ...
        public void renderContent(GuiGraphics graphics, int mouseX, int mouseY, boolean hovered, float partialTick) {
            ...
            PlayerFaceRenderer.draw(graphics, DefaultPlayerSkin.getDefaultSkin(), x, middle - HEAD_SIZE / 2, HEAD_SIZE);
            ...
            graphics.drawString(font, fit(font, friend.status(), textWidth), textX, top + font.lineHeight + TEXT_GAP, ONLINE_STATUS);
        }
